---
title: "Multi-omics data integration with Co-inertia analysis"
author: "BS"
date: "16/10/2022"
...
1. normal wide-table format with compound names as rows (first column (named as a "Variable"), followed by samples in columns;
2. data should be already log2 transformed and should not contain any missing values.
...
modified from: https://du-bii.github.io/module-6-Integrative-Bioinformatics/current/session4/dubii_session4_ProMetIS_practical.html 
```{r}
...
group labels will be randomly permuted and RV coefficient will be calculated for the permuted data
(function works very slowly)
